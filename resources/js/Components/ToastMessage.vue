<template>
    <div id="toast-success" class="fixed right-2 bottom-2 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        <div
            class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg"
            :class="status[atual_status].color_class">
            <Icon :icon="status[atual_status].icon" />
