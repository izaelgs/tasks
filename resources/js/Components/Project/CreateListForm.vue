<template>
    <div class="col-span-2 text-white overflow-hidden shadow-sm rounded-lg">
        <form
            class="text-white p-4 bg-gradient-to-r from-violet-500 to-blue-400 overflow-hidden shadow-sm"
